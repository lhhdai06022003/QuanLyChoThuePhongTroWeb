...
namespace QuanLyChoThuePhongTroWeb.Areas.QuanLyNhaTro.Helpers
{
    public static class VietQRHelper
    {
        ...
        public static string GenerateVietQRString(string bankIdOrBin, string accountNumber, double amount, string memo)
        {
            ...
            // Sub-tag 00: GUID (0014A0000000720011)
            string subGUID = "0014A0000000720011";
            // Sub-tag 01: Beneficiary details
            // Sub-sub-tag 00: Bank BIN (0006 + bin)
            string subSubBin = $"0006{bin}";
            // Sub-sub-tag 01: Account number (01 + length + acc)
            ...
            // Sub-tag 02: Service Code (0208QRIBFTTA)
