...
namespace QuanLyChoThuePhongTroWeb.Areas.QuanLyNhaTro.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? branchId, int? year, int? month)
        {
            ...
            var model = await GetDashboardDataAsync(branchId, selectedYear, selectedMonth);
            return View(model);
        }
        ...
        {
            var model = await GetDashboardDataAsync(branchId, year, month);
        ...
        private async Task<DashboardViewModel> GetDashboardDataAsync(int? branchId, int selectedYear, int selectedMonth)
        {
            var today = DateTime.Now;
