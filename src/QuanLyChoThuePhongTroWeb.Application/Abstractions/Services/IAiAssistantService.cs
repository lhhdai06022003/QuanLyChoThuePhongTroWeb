...
namespace QuanLyChoThuePhongTroWeb.Application.Abstractions.Services
{
    public interface IAiAssistantService
    {
        ...
        Task<decimal> GetDoanhThuThucThuAsync(DateTime tuNgay, DateTime denNgay);
        
        Task<List<PhongTrongRes>> GetPhongTrongAsync(decimal? mucGiaToiDa);
        ...
        Task<decimal> GetCongNoPhongAsync(string soPhong);
